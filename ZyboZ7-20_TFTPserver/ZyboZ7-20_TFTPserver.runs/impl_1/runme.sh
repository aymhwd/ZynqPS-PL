...
HD_PWD='D:/PyramidTech/5-Design_Document/LwIP/TFTP/ZyboZ7-20_TFTPserver/ZyboZ7-20_TFTPserver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tftp_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tftp_bd_wrapper.tcl -notrace
