...
HD_PWD='D:/PyramidTech/5-Design_Document/LwIP/TFTP/ZyboZ7-20_TFTPserver/ZyboZ7-20_TFTPserver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tftp_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tftp_bd_wrapper.tcl
